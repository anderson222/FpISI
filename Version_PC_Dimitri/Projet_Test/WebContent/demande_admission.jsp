...
<body>
	...
	<form action="SoumettreDossierEtudiantServlet" method="post" >
		...
		<c:forEach items="${requestScope.liste_programmes}" var="prog">
		...
		<c:forEach items="${requestScope.liste_sessions}" var="session">
