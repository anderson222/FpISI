...
public class SoumettreDossierEtudiantServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!prenom.equals("") && !nom.equals("") && !courriel.equals("")){
			...
			DossierEtudiantAction.ajouterDossierEtudiant(prenom, nom, courriel);
			AjouterProgrammeSessionAction.ajouterChoixProgramme(choix_programmes);
			AjouterProgrammeSessionAction.ajouterChoixSession(choix_sessions);
